...
async function test() {
  ...
  console.log(Buffer.from("testKey01"));
  ...
  await trie.put(Buffer.from("testKey01"), Buffer.from("testValue0"));
  await trie.put(Buffer.from("testKeyAB"), Buffer.from("testValueA"));
